            ...
            return [
                {
                    id: "colStatus",
                    type: "MULTI_SELECT",
                    value: SmartDataGrid.FakeLocalSource.getFilterData("colStatus", rows)
                },
                {
                    id: "colCCP",
                    type: "MULTI_SELECT",
                    value: SmartDataGrid.FakeLocalSource.getFilterData("colCCP", rows)
                },
                {
                    id: "colTradeId",
                    type: "FREE_TEXT",
                ...
                },
                {
                    id: "colCurrency",
                    type: "MULTI_SELECT",
                    value: SmartDataGrid.FakeLocalSource.getFilterData("colCurrency", rows)
                },
                {
                    id: "colBuySell",
                    type: "MULTI_SELECT",
                    value: SmartDataGrid.FakeLocalSource.getFilterData("colBuySell", rows)
                }
            ];
        }
